    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests()
                .antMatchers("/extractInvoice/**","/tqm/**", "/login", "/login/**", "/assets/**",
                        "/css/**", "/img/**", "/js/**","/fonts/**", "/image.jsp", "/zc/**","/*.jsp","/wxdy/wxCallBack","/ding/**","/dinglrkpd/**","/dinglrkpd2/**","/dinglrgfxx/**","/dinglrspxx/**","/dingqkp/**","/lrkpd/getSpxq","/suiteCallBackController/**","/dingpc/**").permitAll()
