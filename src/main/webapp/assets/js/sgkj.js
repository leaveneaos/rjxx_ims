   ...
   /* var jyzfmx_table = $('#jyzfmx_table').DataTable({
    ...
    $("#add").click(function () {
            ...
            jyspmx_table.row.add([
                ...
                '<input type="text" id="spsl" name="spsl" class="NumText" style="text-align:right">',
                '<input type="text" id="spdj" name="spdj" class="NumText" style="text-align:right">',
                '<input type="text" id="spje" name="spje" class="NumText" style="text-align:right">',
