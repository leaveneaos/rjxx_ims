            ...
            $("#new").click(function() {
                $.ajax({
                    ...
                    success : function(data) {
                        var list =data.data;
                        var allHtml='';
                        var quanxuan='<tr align="left"><td><input type="checkbox" id="spz" onclick="qxsp(this)" name="" value="roles" />&nbsp;&nbsp;全选</td> </tr>';
                        var html='';
                    ...
                    $.ajax({
                        ...
                        "type": "POST", success: function (data) {
                            if (data.success) {
                                ...
                                spbm.append(option);
                                for (var i = 0; i < list.length; i++) {
                                    option = $("<option>").text(list[i].spbm +"|"+ list[i].spmc).val(
                                        list[i].spbm);
                                    spbm.append(option);
                                }
                            } else {
        ...
        setForm : function(data) {
            ...
            $.ajax({
                ...
                success : function(datas) {
                    var list =datas.data;
                    for (var i = 0; i < list.length; i++) {
                        var option = $("<option>").text(list[i].spbm +"|"+ list[i].spmc).val(
                            list[i].spbm);
                        spbm.append(option);
                    }
