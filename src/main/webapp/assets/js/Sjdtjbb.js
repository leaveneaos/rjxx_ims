...
$(function () {
    ...
    var action = {
        ...
        config: {
            saveURL: 'sjdtjbb/save',
            getURL: 'sjdtjbb/getList',
            getPreDay: 'sjdtjbb/getPre',
            getLaterDay: 'sjdtjbb/getLater',
            exportURL: 'sjdtjbb/export'
        },
        showFp: function (data) {
            if (data.kprq == null || data.kprq1 == null || "" == data.kprq || "" == data.kprq1) {
                return;
            }
            var _this = this;
        ...
        dateAc: function () {
            ...
            el.$jsDate.on('changeDate.datepicker.amui', function () {
                var kprq = el.$jsDate.val();
                var kprq1 = el.$jsDate1.val();
                _this.showFp({kprq: kprq, kprq1: kprq1}); //传参格式{'随便写':参数值}
            });
            el.$jsDate1.on('changeDate.datepicker.amui', function () {
                var kprq = el.$jsDate.val();
                var kprq1 = el.$jsDate1.val();
                _this.showFp({kprq: kprq, kprq1: kprq1}); //传参格式{'随便写':参数值}
            });
