...
<meta name="keywords" content="发票提取查询" />
<meta name="viewport"
		...
		<div class="admin-content">
			<div class="am-cf am-padding">
				<div class="am-fl am-cf">
					<strong class="am-text-primary am-text-lg">查询统计</strong> / <strong>发票提取查询</strong>
				</div>
			</div>
			<hr />
			<div class="am-g  am-padding-top">
				<form action="<c:url value='fpcx/exportExcel'/>"
					...
					<div class="am-g">
						...
						<div class="am-u-sm-6">
							<div class="am-form-group">
								<label for="s_kprqq" class="am-u-sm-3 am-form-label">提取日期</label>
								<div class="am-u-sm-9">
						...
						<div class="am-u-sm-6">
							<div class="am-form-group">
								<label for="s_tqsb" class="am-u-sm-3 am-form-label">提取设备</label>
								<div class="am-u-sm-9">
									<select id="s_tqsb" name="tqsb">
						...
						<div class="am-u-sm-6">
							<div class="am-form-group">
								<label for="s_jlly" class="am-u-sm-3 am-form-label">记录来源</label>
								<div class="am-u-sm-9">
								    <select id="s_jlly" name="jlly">
									      <option value="">-----请选择-----</option>
