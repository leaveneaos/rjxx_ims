...
<!-- 								style="text-decoration: underline; margin-left: 10px;">配置导入文件对照关系</a> -->
	...
	<div class="am-modal am-modal-no-btn" tabindex="-1" id="my-alert-edit">
		<div class="am-modal-dialog"  style="overflow:auto">
			<div class="am-modal-hd am-modal-footer-hd">
				录入开票单 <a href="javascript: void(0)" class="am-close am-close-spin"
					data-am-modal-close>&times;</a>
			</div>
						...
						<form class="am-form am-form-horizontal" id="main_form">
							<fieldset>
                                ...
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-4">
                                    <select id="select_xfid" name="xfid_edit" onchange="getKpd()" required>
										<option value="">---选择销方---</option>
										<c:forEach items="${xfList}" var="item">
					...
					<div class="am-tab-panel am-fade" id="tab2">
						<form class="am-form am-form-horizontal" id="mx_form">
							<fieldset>
								...
								<div class="am-form-group">
									<label for="mc_edit" class="am-u-sm-2 am-form-label"><span style="color: red;">*</span>名称</label>
								...
								<div class="am-form-group">
									...
									<label for="je_edit" class="am-u-sm-2 am-form-label" style="padding-left:0px"><span style="color: red;">*</span>金额(不含税)</label>
									...
									<label for="hsje_edit" class="am-u-sm-2 am-form-label"><span style="color: red;">*</span>金额(含税)</label>
								...
								<div class="am-form-group">
									<label for="jshj_edit" class="am-u-sm-2 am-form-label"><span style="color: red;">*</span>价税合计</label>

									<div class="am-u-sm-4">
										<input type="text" id="jshj_edit" readonly="readonly" placeholder="输入价税合计...">
									</div>
								</div>
								<div class="am-form-group">
									<label for="sltaxrate_edit" class="am-u-sm-2 am-form-label"><span style="color: red;">*</span>税率</label>

									<div class="am-u-sm-4">
										<input type="text" id="sltaxrate_edit" value="0.17"
											placeholder="" required readonly>
									</div>
									<label for="se_edit" class="am-u-sm-2 am-form-label"><span style="color: red;">*</span>税额</label>

									<div class="am-u-sm-4">
										<input type="text" id="se_edit" placeholder="" required readonly>
									</div>
								</div>
								<div>
