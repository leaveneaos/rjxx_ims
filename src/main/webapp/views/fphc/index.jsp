								...
								<div class="am-g">
									...
									<div class="am-u-sm-12">
										<div class="am-u-sm-4">
											...
											<div class="am-input-group am-datepicker-date am-u-sm-8"
												data-am-datepicker="{format: 'yyyy-mm-dd'}">
												<input type="text" id="kssj" class="am-form-field" readonly>
												<span class="am-input-group-btn am-datepicker-add-on">
													<button class="am-btn am-btn-default" type="button">
														<span class="am-icon-calendar"></span>
													</button>
										...
										<div class="am-u-sm-2">
											<div class="am-form-group" style="margin-top: 13px;">
												<a href="javascript:void(0);" id="day31"><u>近3天</u></a> <a
													id="day71" href="javascript:void(0);"
													style="margin-left: 2%"><u>近7天</u></a> <a
													href="javascript:void(0);" id="day301"
													style="margin-left: 2%;"><u>近30天</u></a>
											</div>
										</div>
										<div class="am-u-sm-2">
											<div class="am-form-group" style="width: 100%">
												<button type="button" id="kp_kp1" style="width: 100%"
													class="am-btn am-radius am-btn-success">
													<span></span> 查询
												</button>
											</div>
