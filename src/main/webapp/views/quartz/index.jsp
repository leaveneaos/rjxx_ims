...
<![endif]-->
			...
			<div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
				<div class="widget am-cf">
					<div class="admin-content">
									...
									<div class="am-form-group">
										<div class="am-btn-toolbar">
											<div class="am-btn-group am-btn-group-xs">
													<button type="button" id="add" onclick="addpage();"
												...
												<button type="button" id="edit" onclick="editpage();"
						...
						<!-- model -->
    <div class="am-modal am-modal-no-btn" tabindex="-1" id="addtask">
            ...
            <div class="am-tab-panel am-fade am-in am-active">
                ...
                <form  class="am-form am-form-horizontal" id="add_form">
										<fieldset>
											...
											<div class="am-margin">
												 <button type="button" id="js-add" 
															class="am-btn am-btn-default am-btn-success">
															<span></span> 确定
												</button>
												<button type="button" id="js-addclose"  
															class="am-btn am-btn-default am-btn-danger">
															<span></span> 关闭
												</button>
											</div>
    ...
    <div class="am-modal am-modal-no-btn" tabindex="-1" id="edittask">
        <div class="am-modal-dialog">
            <div class="am-modal-hd">修改定时任务
            </div>
            <div class="am-tab-panel am-fade am-in am-active">
                <hr/>
                <form  class="am-form am-form-horizontal" id="edit_form">
										<fieldset>

											<div class="am-form-group">
												<label for="jobname1" class="am-u-sm-2 am-form-label">JobName</label>

												<div class="am-u-sm-4">
													<input type="text" id="jobname1" name="jobname1"
														placeholder="任务名" required >
												</div>
												<label for="jobgroup1" class="am-u-sm-2 am-form-label">JobGroup</label>
                        					<div class="am-u-sm-4 am-u-end">
													<select id="jobgroup1" name="jobgroup1"  required >
														<option value="">请选择任务组</option>
                                                        <option value="Job_group">JobGroup</option>
													</select>
												</div>
											...
											<div class="am-form-group">
											    <label for="jobdescription1" class="am-u-sm-2 am-form-label">JobDescription</label>

												<div class="am-u-sm-4">
													<input type="text" id="jobdescription1" name="jobdescription1"
														placeholder="任务描述"  required>
												</div>
												<label for="cronexpression1" class="am-u-sm-2 am-form-label">CronExpression</label>

												<div class="am-u-sm-4">
													<input type="text" id="cronexpression1" name="cronexpression1"
														   placeholder="Cron表达式..."  required>
												</div>
											...
											<div class="am-margin">
												 <button type="button" id="js-edit" 
															class="am-btn am-btn-default am-btn-success">
															<span></span> 确定
												</button>
												<button type="button" id="js-editclose"  
															class="am-btn am-btn-default am-btn-danger">
															<span></span> 关闭
												</button>
											</div>
...
function addpage(){
	  //$("#add_form").reset();
	  $('#addtask').modal({"width": 820, "height": 300});
...
function editpage(){
      ...
      if(group.length==0){
    	  ...
    	  //$("#edit_form").reset();
    	  $('#edittask').modal({"width": 820, "height": 300});
      }
