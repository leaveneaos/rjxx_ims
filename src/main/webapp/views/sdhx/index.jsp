...
<title>重新生成PDF</title>
<meta name="description" content="重新生成PDF">
<meta name="keywords" content="重新生成PDF">
<meta name="viewport"
...
<input type="hidden" id="searchbz" name="searchbz" value="0">
								...
								<div id="doc-oc-demo3" class="am-offcanvas">
									<div class="am-offcanvas-bar am-offcanvas-bar-flip">
										<form class="js-search-form am-form">
											...
											<div class="am-offcanvas-content top-position">
												<div class="am-form-group">
													<label for="s_kprqq" class="am-u-sm-4 am-form-label">交易日期</label>
	...
	<script src="assets/js/sdhx.js"></script>
