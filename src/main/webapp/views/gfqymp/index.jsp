                    ...
                    <div class="am-g">
                        <div class="am-u-sm-12">
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-8">
                                    <input type="text" id="xg_gfsh" name="xq_ddrq" placeholder=""/>
                                </div>
                            </div>
                            <div class="am-form-group">
                                <label for="xq_je" class="am-u-sm-4 am-form-label">地址</label>
                                <div class="am-u-sm-8">
                                    <input type="text" id="xg_gfdz" name="xq_je" placeholder=""/>
                                </div>
                            </div>
                            <div class="am-form-group">
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-8">
                                    <input type="text" id="xg_gfyh" name="xq_je" placeholder=""/>
                                </div>
                            </div>
                            <div class="am-form-group">
                                <label for="xq_mdh" class="am-u-sm-4 am-form-label">开户账号</label>
                                <div class="am-u-sm-8">
                                    <input type="text" id="xg_gfyhzh" name="xq_mdh" placeholder=""/>
                                </div>
                            </div>
						 </div>
                        <div class="am-u-sm-12">
                            <div class="am-form-group">
                                <div class="am-u-sm-12  am-text-center">
                                    <button type="button" id="update"  class="am-btn am-btn-secondary">保存</button>
