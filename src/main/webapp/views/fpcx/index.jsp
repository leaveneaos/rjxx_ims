		...
		<div class="admin-content">
			<div class="am-cf am-padding">
				<div class="am-fl am-cf">
					<strong class="am-text-primary am-text-lg">查询统计</strong> / <strong>发票查询</strong>
				</div>
			</div>
			<hr />
			<div class="am-g  am-padding-top">
				<form action="<c:url value='fpcx/exportExcel'/>"
					...
					<div class="am-g">
						...
						<div class="am-u-sm-6">
							<div class="am-form-group">
								<label for="s_fpczlx" class="am-u-sm-3 am-form-label">操作类型</label>
								<div class="am-u-sm-9">
						...
						<div class="am-u-sm-6">
							<div class="am-form-group">
								<label for="s_dyzt" class="am-u-sm-3 am-form-label">打印状态</label>
								<div class="am-u-sm-9">
						...
						<div class="am-u-sm-6">
							<label class="am-u-sm-3 am-form-label">开票点</label>
							<div class="am-u-sm-9">
					...
					<div class="am-u-sm-12  am-padding  am-text-center">
						...
						<button type="button" class="js-print  am-btn am-btn-warning">批量打印</button>
		...
		<div class="am-modal am-modal-no-btn" tabindex="-1" id="fpxx">
			<div class="am-modal-dialog">
				<div class="am-modal-hd">
					发票查询详情 <a href="javascript: void(0)" class="am-close am-close-spin"
						...
						<div class="am-g" >
							<div class="am-u-sm-12">
								<div class="am-form-group">
									...
									<div class="am-u-sm-8">
										<input type="text" id="ddh" name="ddh" placeholder="" readonly />
									</div>
								</div>
								<div class="am-form-group">
							...
							<div class="am-u-sm-12">
								...
								<div class="am-form-group">
									...
									<div class="am-u-sm-8">
										<input type="text" id="sh" name="sh" placeholder="" readonly />
									</div>
								</div>
								<div class="am-form-group">
									<label for="yh" class="am-u-sm-4 am-form-label">银行</label>
									<div class="am-u-sm-8">
										<input type="text" id="yh" name="yh" placeholder="" readonly />
									</div>
								</div>
								<div class="am-form-group">
								...
								<div class="am-u-sm-12">
									...
									<div class="am-form-group" id="xzxzcsz">
										<label class="am-u-sm-4 am-form-label"><input
											...
											<label
											class="am-u-sm-4 am-form-label"><input name="column"
											type="checkbox" value="gfsjh" id="gfsjh" />购方手机号</label>
									...
									<div class="am-form-group" id="xzxzcsz">
										<label class="am-u-sm-4 am-form-label"><input
											...
											name="column" type="checkbox" value="gfdz" id="gfdz" />购方地址</label> <label
											class="am-u-sm-4 am-form-label"><input name="column"
											type="checkbox" value="gfdh" id="gfdh" />购方电话</label>
									</div>
									<div class="am-form-group" id="xzxzcsz">
										<label class="am-u-sm-4 am-form-label"><input
										...
										<label class="am-u-sm-4 am-form-label"><input
											...
											class="am-u-sm-4 am-form-label"><input name="column"
											type="checkbox" value="skr" id="skr" />收款人</label>
									</div>
									<div class="am-form-group" id="xzxzcsz">
										<label class="am-u-sm-4 am-form-label"><input
											name="column" type="checkbox" value="kpr" id="kpr" />开票人</label> <label
											class="am-u-sm-4 am-form-label"><input name="column"
											type="checkbox" value="fhr" id="fhr" />复核人</label> <label
											class="am-u-sm-4 am-form-label"><input name="column"
											type="checkbox" value="ssyf" id="ssyf" />所属月份</label>
									</div>
									<div class="am-form-group" id="xzxzcsz">
										<label class="am-u-sm-4 am-form-label"><input
									...
									<div class="am-form-group" id="xzxzcsz">
										<label class="am-u-sm-4 am-form-label"><input
											...
											<label style="display: none;" class="am-u-sm-4 am-form-label"><input
						...
						<div class="am-modal-bd" style="overflow: auto; height: 400px;">
							...
							<div class="am-g">
								<div class="am-u-sm-12">
									...
									<label
											class="am-u-sm-4 am-form-label"><input name="column"
											type="checkbox" value="gfsjh" id="gfsjh1" />购方手机号</label>
									</div>
									<div class="am-form-group" id="xzxzcsz1">
										<label class="am-u-sm-4 am-form-label"><input
									...
									<div class="am-form-group" id="xzxzcsz1">
										<label class="am-u-sm-4 am-form-label"><input
											name="column" type="checkbox" value="gfemail" id="gfemail1" />购方email</label>
										<label class="am-u-sm-4 am-form-label"><input
											name="column" type="checkbox" value="bz" id="bz1" />备注</label> <label
											class="am-u-sm-4 am-form-label"><input name="column"
											type="checkbox" value="skr" id="skr1" />收款人</label>
									</div>
									<div class="am-form-group" id="xzxzcsz1">
										<label class="am-u-sm-4 am-form-label"><input
											name="column" type="checkbox" value="kpr" id="kpr1" />开票人</label> <label
											class="am-u-sm-4 am-form-label"><input name="column"
											type="checkbox" value="fhr" id="fhr1" />复核人</label> <label
											class="am-u-sm-4 am-form-label"><input name="column"
											type="checkbox" value="ssyf" id="ssyf1" />所属月份</label>
									</div>
									<div class="am-form-group" id="xzxzcsz1">
										<label class="am-u-sm-4 am-form-label"><input
										...
										<label class="am-u-sm-4 am-form-label"><input
											name="column" type="checkbox" value="ykpjshj" id="ykpjshj1" />已开票价税合计</label>
									</div>
									<div class="am-form-group" id="xzxzcsz">
										<label class="am-u-sm-4 am-form-label"><input
