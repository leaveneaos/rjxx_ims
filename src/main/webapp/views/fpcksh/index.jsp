...
<title>发票重开审核</title>
<meta name="description" content="发票重开审核">
<meta name="keywords" content="发票重开审核">
<meta name="viewport"
...
<![endif]-->
		...
		<div class="admin-content">
			<div class="am-cf am-padding">
				<div class="am-fl am-cf">
					<strong class="am-text-primary am-text-lg">业务处理</strong> / <strong>发票重开审核</strong>
				</div>
			</div>
			<hr />
			<input type="hidden" id="djh">
			...
			<div class="am-g  am-padding-top">
				<form action="#" class="js-search-form  am-form am-form-horizontal">
					<div class="am-g">
						...
						<div class="am-u-sm-6">
							<div class="am-form-group">
								<label for="s_gfmc" class="am-u-sm-3 am-form-label">原购方名称</label>
								<div class="am-u-sm-9">
				...
				<div class="am-u-sm-12  am-padding  am-text-center">
					...
					<button type="button" class="js-agree am-btn am-btn-success">确认重开</button>
        ...
        <div class="am-modal am-modal-no-btn" tabindex="-1" id="disagreeModal">
			<div class="am-modal-dialog">
				<div class="am-modal-hd">
					重开审核撤销 <a href="javascript: void(0)" class="am-close am-close-spin"
	...
	<script src="assets/js/fpcksh.js"></script>
</body>
</html>
